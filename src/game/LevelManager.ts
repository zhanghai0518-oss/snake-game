...
const LEVELS: LevelConfig[] = [
  {
    ...
    availableAnimals: [AnimalType.MOUSE, AnimalType.SNAKE_EGG],
    availableEnemies: [],
  ...
  },
  {
    ...
    availableAnimals: [AnimalType.MOUSE, AnimalType.SNAKE_EGG, AnimalType.FROG, AnimalType.BIRD_EGG],
  ...
  },
  {
    ...
    availableAnimals: [AnimalType.MOUSE, AnimalType.SNAKE_EGG, AnimalType.FROG, AnimalType.BIRD_EGG, AnimalType.RABBIT],
  ...
  {
    level: 6, name: '狮王领地', targetScore: 5000, scoreMultiplier: 4,
